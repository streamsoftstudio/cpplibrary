...
//  LoadTester
//
//  Created by Andrija Milovanovic on 3/12/17.
//  Copyright © 2017 Andrija. All rights reserved.
//
...
namespace Threading
{
    ...
    namespace DispatchThread
    {
        inline ThreadPool& getThread(void)
        {
        ...
        {
            return getThread().submit(std::forward<Func>(func), std::forward<Args>(args)...);
        }
    }
